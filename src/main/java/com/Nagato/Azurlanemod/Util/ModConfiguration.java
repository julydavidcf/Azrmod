package com.Nagato.Azurlanemod.Util;
...
public class ModConfiguration 
{
	...
	{
		Azurlanemod.config = new File(event.getModConfigurationDirectory() + "/" + Reference.MOD_ID);
        Azurlanemod.config.mkdirs();
		init(new File(Azurlanemod.config.getPath(), Reference.MOD_ID + ".cfg"));
	}
} 
