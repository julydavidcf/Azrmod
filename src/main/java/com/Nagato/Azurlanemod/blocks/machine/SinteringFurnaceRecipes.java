...
{	
	...
	{
	      addSinteringRecipe(new ItemStack(ModItems.OILSEED),new ItemStack(ModItems.REDDIMOND),new ItemStack(ModItems.OIL),5.0F);
	      addSinteringRecipe(new ItemStack(Blocks.DIRT),new ItemStack(Blocks.STONE),new ItemStack(Blocks.BEDROCK),5.0F);
