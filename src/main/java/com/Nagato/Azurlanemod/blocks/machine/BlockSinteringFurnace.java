package com.Nagato.Azurlanemod.blocks.machine;

import com.Nagato.Azurlanemod.Azurlanemod;
import com.Nagato.Azurlanemod.Util.Reference;
import com.Nagato.Azurlanemod.blocks.BlockBase;
...
public class BlockSinteringFurnace extends BlockBase
{
    ...
    {
        return Item.getItemFromBlock(ModBlock.SINTERING_FURNACE);
    }

    @Override
    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
    {
        return new ItemStack(ModBlock.SINTERING_FURNACE);
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        if(!worldIn.isRemote)
        {
            playerIn.openGui(Azurlanemod.instance, Reference.GUI_SINTERING_FURNACE, worldIn, pos.getX(), pos.getY(), pos.getZ());
        }
